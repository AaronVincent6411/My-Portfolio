...
function Overview () {
  ...
  return (
    <section id="overview" style={myStyle} className="flex items-center justify-center">
      <div className="flex flex-col relative w-[90vw] h-[90vh] bg-[#222429] rounded-[40px]">
        <div className="flex text-white">
          <Header />
          <Link to='/'>
            <img src="https://live.staticflickr.com/65535/52783270220_87fdc16456_b.jpg" className='lionex-png rounded-full w-8 h-8 absolute right-0 mr-20 mt-5'/>
          </Link>
        </div>
        <div className="w-full h-[2px] relative bg-white top-[8%] opacity-5"></div>
        <div className="text-white relative">
          <h1 className="text-3xl font-semibold mt-20 absolute left-[20%]">Overview</h1>
          <div className="rounded-[40px] bg-black h-11 w-72 absolute left-[50rem] top-24" style={{ fontFamily: 'DM Sans, sans-serif' }}>
            <h2 className="text-white ml-4 mt-2 font-sans">Completed Projects</h2>
          </div>
        </div>
      </div>
    </section>
...
{/* <Link to='/'>
<img src="https://live.staticflickr.com/65535/52783270220_87fdc16456_b.jpg" className='lionex-png rounded-lg w-8 h-8 mr-20'/>
</Link>
<div className='line'>
</div> */}
